            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-light">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <form class="form-inline my-2 my-lg-0">
                        <a href="./addProducts.php"><button type="button" class="btn btn-primary"
                                title="Add client">Ajouter produit</button></a>
                                    ...
                                    <table
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th>Image</th>
                                                <th>Libelle</th>
                                                <th>quantite initiale de stock</th>
                                                <th>Action</th>
                                            </tr>
                                        </thead>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><img id="imgs" src="./uploads/<?= $result['photo'] ?>"
                                                        alt="IMG-CATEGORY" width="100px" height="100px"></td>
                                                ...
                                                <td><?php echo $result['quantite_stock'] ?></td>
                                                <td>
                                                    <a href="./updateProducts.php?id=<?= $result[0] ?>"><button
                                                            type="button" class="btn btn-success btn-sm" title="Edit"><i
                                                                class="fa fa-edit"></i></button></a>
                                                    <a href="./deleteProducts.php?id=<?= $result[0] ?>"
                                                        onclick="confirmer(event);"><button type="button"
                                                            class="btn btn-danger btn-sm" title="Delete"><i
                                                                class="fa fa-trash"></i></button></a>
                                                    <a href="./detailProducts.php?id=<?= $result[0] ?>"><button
                                                            type="button" class="btn btn-primary btn-sm" title="Detail">
                                                            <!-- <img src="../images/icons/icons8-details.png" width="14px" height="13px"> -->
                                                            <img src="../images/icons/eye.svg" width="12px"
                                                                height="12px">
                                                        </button></a>
                                                </td>
                                            </tr>
