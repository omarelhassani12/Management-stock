                ...
                <ul id="main-menu" class="metismenu">
                    ...
                    <li>
                        ...
                        <ul>
                            ...
                            <li><a href="../Clients/liste_form_excel.php">liste des client pour la form excel </a></li>
                        </ul>
                    </li>
                    <li class="active">
                        ...
                        <ul>
                            ...
                            <li class="active"><a href="./liste_form_excel.php">liste des fournisseurs pour la form
                                    excel</a></li>
                        </ul>
                    </li>
                    <li>
                        <a href="javascript:void(0)" class="has-arrow"><i class="fa fa-cubes"></i><span>Gestion des
                                produits</span></a>
                        <ul>
                            <li><a href="../Products/index.php">les produits</a></li>
