                ...
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            ...
                            <a class="dropdown-item active" href="./profile.php"><i
                    ...
                    <div class="card pricing2">
                        <div class="body">
                            <div class="pricing-plan">
                                <img src="./uploads/<?= $res['photo']; ?> " alt="User" class="pricing-img"
                                    width="200px">
                                <h2 class="pricing-header"><?= $res['nom']; ?></h2>
                                <ul class="pricing-features">
                                    <li><?= $res['email']; ?></li>
                                    <!-- <li><?= $res['password']; ?></li> -->
                                    <!-- : <li><?= $res['nom_entreprise']; ?></li> -->
                                    <!-- <li><?= $res['country']; ?></li> -->
                                </ul>
