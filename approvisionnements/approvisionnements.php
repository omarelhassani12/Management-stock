    ...
    <nav class="navbar custom-navbar navbar-expand-lg py-2">
        <div class="container-fluid px-0">
            ...
            <div id="navbar_main">
                ...
                <script>
                function confirmerlogout(event) {
                    if (!confirm('Voulez-vous deconnexion !!')) {
            ...
            <nav class="sidebar">
                ...
                <ul id="main-menu" class="metismenu">
                    ...
                    <li class="active">
                        ...
                        <ul>
                            <li class="active"><a href="./approvisionnements.php">les approvisionnements</a></li>
                            <li><a href="./addApprovisionnements.php">ajouter</a></li>
                        </ul>
                    </li>
            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-light">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <form class="form-inline my-2 my-lg-0">
                        <a href="./addApprovisionnements.php"><button type="button" class="btn btn-primary"
                                title="Add client">Add
                                approvisionnements</button></a>
                                    ...
                                    <table
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo $result['date_achat']; ?></td>
                                                <?php
                                                        $idf =  $result['idFournisseur'];
                                                        $sql2 = $db->prepare("SELECT nom FROM Fournisseur where id='$idf'");
                                                        $res = $sql2->execute();
                                                        $res = $sql2->fetch();
                                                        ?>
                                                <td><?php echo $res['nom']; ?></td>
                                                <td><?php echo $result['libelleProduit']; ?></td>
                                                <td><?php echo $result['prix_achat']; ?></td>
                                                <td><?php echo $result['quantite_achetes']; ?></td>
                                                <td>
                                                    <a href="./deleteapprovisionnements.php?id=<?php echo $result['id']; ?>"
                                                        onclick="return confirm('Voulez-vous supprimer l\'approvisionnement ?');">
