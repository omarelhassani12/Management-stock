        ...
        if (in_array($fileActualExt, $allowed)) {
            if ($fileError === 0) {
                if ($fileSize < 1000000) {
                    ...
                    $sql = $db->prepare("UPDATE categories SET photo='$fileNameNew',libelle='$libelle' WHERE id='$id'");
                    $sql->execute();
                    header('Location: index.php');
                } else {
                ...
                <ul id="main-menu" class="metismenu">
                    ...
                    <li>
                        ...
                        <ul>
                            ...
                            <li><a href="../Fournisseur/liste_form_excel.php">iste des fournisseurs pour la form
                                    excel</a></li>
                            ...
                            <div class="body">
                                <form id="basic-form" method="POST" action="" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        <label>Image</label>
                                        <br>
                                        <input name="photo" type="file" value="./uploads/<?= $result['photo'] ?>"
                                            alt='IMG-CATEGORY'>
                                    </div>
