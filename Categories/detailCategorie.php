                        ...
                        <div class="card">
                            <div class="header">
                                <?php
                                    ...
                                    ?>
                                <h2><?php echo $result['libelle']; ?> <small><?php echo $cate['all_produits']; ?>
                                        produits</small></h2>
                                </tr>
                        ...
                        <div class="card pricing2">
                            <div class="body" style="height: 474px; width: 362px;">
                                <div class="pricing-plan" style="position:relative; left: -40px;">
                                    <h2 class="pricing-header"><?php echo $res['libelle']; ?></h2>
                                    <img src="../Products/uploads/<?= $res['photo']; ?>" alt="" class="pricing-img"
                                        width="200px" height="200px">

                                    <span class="pricing-price"><?= $res['prix_vente']; ?></span>
                                    <br>
                                    <a href="../Products/detailProducts.php?id=<?= $res[0]; ?>"
