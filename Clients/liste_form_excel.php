                ...
                <ul id="main-menu" class="metismenu">
                    ...
                    <li class="active">
                        ...
                        <ul>
                            ...
                            <li class="active"><a href="./liste_form_excel.php">liste des clients pour la form excel</a>
                            </li>
            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-light">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <form class="form-inline my-2 my-lg-0">
                        <a href="./Ajouterclient.php"><button type="button" class="btn btn-primary"
                                title="Add client">Add Client</button></a>
