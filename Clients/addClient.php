...
<?php
    try {
        if (isset($_POST['submit']) && !empty($_POST['nom']) && !empty($_POST['num']) && !empty($_POST['adresse']) && !empty($_POST['adresse'])) {
            ...
            $sql = "INSERT INTO clients(nom,tele,adresse,email) VALUES(:nom,:num,:adresse,:email)";
            $req = $db->prepare($sql);
                ...
                <ul id="main-menu" class="metismenu">
                    ...
                    <li class="active">
                        ...
                        <ul>
                            ...
                            <li class="active"><a href="./addClient.php">ajouter un client</a></li>
