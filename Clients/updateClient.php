...
<?php
    try {
        ...
        if (isset($_POST["submit"])) {
            ...
            $email = $_POST['email'];
            $req = $db->prepare('UPDATE clients set nom=? WHERE id=?');
            $req->execute([$nom, $id]);
            $res = $db->prepare('UPDATE clients set tele=? WHERE id=?');
            $res->execute([$tele, $id]);
            $ren = $db->prepare('UPDATE clients set adresse=? WHERE id=?');
            $ren->execute([$prenom, $id]);
            $rem = $db->prepare('UPDATE clients set email=? WHERE id=?');
                ...
                <ul id="main-menu" class="metismenu">
                    ...
                    <li>
                        ...
                        <ul>
                            ...
                            <li><a href="../Fournisseur/addrFournisseur.php">ajouter un fournisseurs</a></li>
