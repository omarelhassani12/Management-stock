                ...
                <ul id="main-menu" class="metismenu">
                    ...
                    <li class="active">
                        <a href="javascript:void(0)" class="has-arrow"><i class="fa fa-user"></i><span>Gestion des
                                clients</span></a>
                        <ul>
                            <li class="active"><a href="./index.php">liste des clients</a></li>
            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-light">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <form class="form-inline my-2 my-lg-0">
                        <a href="./addClient.php"><button type="button" class="btn btn-primary" title="Add client">Add
                                Client</button></a>
                                    ...
                                    <table
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="./updateClient.php?id=<?= $result[0] ?>"><button
                                                            type="button" class="btn btn-success btn-sm" title="Edit"><i
                                                                class="fa fa-edit"></i></button></a>
                                                    <a href="./deleteClient.php?id=<?= $result[0] ?>"
                                        ...
                                        function confirmer(event) {
                                            if (!confirm('Voulez-vous supprimer le client !!')) {
                                                event.preventDefault();
                                            }
                                        }
                                        </script>
