...
if (isset($valider)) {
  include("config.php");
  $res = $db->prepare("SELECT * from users where email=? and password=?");
                            ...
                            <div class="card mb-3">
                                ...
                                <div class="card-body">
                                    ...
                                    <form class="row g-3 needs-validation" name="fo" method="post" action="">
                                        ...
                                        <div class="col-12">
                                            <p class="small mb-0">Don't have account? <a href="inscription.php">Create
                                                    an account</a></p>
                                        </div>
                                    </form>
