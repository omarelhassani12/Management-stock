	...
	<header class="header-v4">
			...
			<div class="wrap-menu-desktop how-shadow1">
				<nav class="limiter-menu-desktop container">
					...
					<div class="wrap-icon-header flex-w flex-r-m">
						...
						<a href="shoping-card.php" class="icon-header-item cl2 hov-cl1 trans-04 p-l-22 p-r-11 icon-header-noti js-show-cart" data-notify="<?=$stmt2->fetchColumn()?>">
		...
		<div class="wrap-header-mobile">
			...
			<div class="wrap-icon-header flex-w flex-r-m m-r-15">
				...
				<a href="shoping-card.php" class="icon-header-item cl2 hov-cl1 trans-04 p-r-11 p-l-10 icon-header-noti " data-notify="<?=$stmt2->fetchColumn()?>">
					<i class="zmdi zmdi-shopping-cart"></i>
				</a>
	...
	<div class="bg0 m-t-23 p-b-140">
		<div class="container">
			...
			<div class="row isotope-grid">
				<?php	
					$id=$_SESSION["id"];						
					$sql = $db->prepare("SELECT * FROM wishes  where user=$id ");
					$sql->execute();
					foreach ($sql as $result) { 
				?>
					...
					<div class="block2">
						...
						<div class="block2-txt flex-w flex-t p-t-14">
							...
							<div class="block2-txt-child2 flex-r p-t-3">
								<a href="deletewishe.php?id=<?= $result[0] ?>" class="btn-addwish-b2 dis-block pos-relative ">
