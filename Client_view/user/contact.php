...
<body class="animsition">
		...
		<div class="container">
			<div class="flex-w flex-tr">
				...
				<div class="size-210 bor10 flex-w flex-col-m p-lr-93 p-tb-30 p-lr-15-lg w-full-md">
                    <?php							
                        $sql = $db->prepare("SELECT * FROM shop_information ");
                        $sql->execute();
                        foreach ($sql as $result) { 
                    ?>
	...
	<!-- Map -->
	<div class="map">
		<div class="size-303" id="google_map" data-map-x="40.691446" data-map-y="-73.886787" data-pin="../images/icons/icon-pin.svg" data-scrollwhell="0" data-draggable="1" data-zoom="11"></div>
	</div>
		...
		<div class="container">
			<div class="row">
				<div class="col-sm-6 col-lg-3 p-b-50">
					...
					<ul>
						<li class="p-b-10">
							<a href="product_women.php" class="stext-107 cl7 hov-cl1 trans-04">
								Women
							</a>
						</li>

						<li class="p-b-10">
							<a href="product_men.php" class="stext-107 cl7 hov-cl1 trans-04">
								Men
							</a>
						</li>

						<li class="p-b-10">
							<a href="product_shoes.php" class="stext-107 cl7 hov-cl1 trans-04">
								Shoes
							</a>
						</li>

						<li class="p-b-10">
							<a href="product_accessories.php" class="stext-107 cl7 hov-cl1 trans-04">
								Accessories
							</a>
						</li>
					</ul>
				...
				<div class="col-sm-6 col-lg-3 p-b-50">
					...
					<p class="stext-107 cl7 size-201">
						Any questions? Let us know in  <?=$result['adress']?> or call us on <?=$result['tel']?>
					</p>
