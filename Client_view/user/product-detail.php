					...
					<div class="p-l-25 p-r-30 p-lr-0-lg">
						<div class="wrap-slick3 flex-sb flex-w">
							...
							<div class="slick3 gallery-lb">
								<div class="item-slick3" data-thumb="<?= $result['image1']?>">
									<div class="wrap-pic-w pos-relative">
										<?php echo '<img src='.$result["image1"].' alt="IMG-PRODUCT">';?>

										<a class="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04" href="<?= $result['image1']?>">
											<i class="fa fa-expand"></i>
										</a>
									</div>
								</div>

								<div class="item-slick3" data-thumb="<?= $result['image2']?>">
									<div class="wrap-pic-w pos-relative">
										<img src=<?=$result["image2"]?> alt="IMG-PRODUCT">

										<a class="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04" href="<?= $result['image2']?>">
											<i class="fa fa-expand"></i>
										</a>
									</div>
								</div>

								<div class="item-slick3" data-thumb="<?= $result['image3']?>">
									<div class="wrap-pic-w pos-relative">
										<img src=<?= $result['image3']?> alt="IMG-PRODUCT">

										<a class="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04" href="<?= $result['image3']?>">
											<i class="fa fa-expand"></i>
										</a>
									</div>
								</div>
								...
								<div class="size-204 respon6-next">
									<div class="rs1-select2 bor8 bg0">
										<select class="js-select2" name="size">
											...
											<option><?= $result['Size1']?> </option>
											<option><?= $result['Size2']?></option>
											<option><?= $result['Size3']?></option>
											<option><?= $result['Size4']?></option>
										</select>
								...
								<div class="size-204 respon6-next">
									<div class="rs1-select2 bor8 bg0">
										<select class="js-select2" name="color">
											<option>Choose an option</option>
											<option><?= $result['color1']?></option>
											<option><?= $result['color2']?></option>
											<option><?= $result['color3']?></option>
										</select>
										<div class="dropDownSelect2"></div>
									</div>
								</div>
								...
								<form action="card.php" method="post">
									<div class="size-204 flex-w flex-m respon6-next">
										...
										<div>
											...
											<input type="hidden" name="image" value="<?=$result["image1"]?>">
											<input type="hidden" name="size" value="<?=$result["Size1"]?>">
											<input type="hidden" name="color" value="<?=$result["color1"]?>">
								...
								<div class="col-sm-10 col-md-8 col-lg-6 m-lr-auto">
									<ul class="p-lr-28 p-lr-15-sm">
										...
										<li class="flex-w flex-t p-b-7">
											...
											<span class="stext-102 cl6 size-206">
												<?= $result['color1']?>, <?= $result['color2']?>, <?= $result['color3']?>
											</span>
										</li>
										...
										<li class="flex-w flex-t p-b-7">
											...
											<span class="stext-102 cl6 size-206">
												<?= $result['Size1']?>, <?= $result['Size2']?>, <?= $result['Size3']?>, <?= $result['Size4']?>
											</span>
										</li>
									</ul>
								</div>
